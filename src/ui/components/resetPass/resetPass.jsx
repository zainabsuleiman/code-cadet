  ...
  return (
    <div className="flex flex-col gap-y-5 bg-bgcolor1 w-96 rounded-xl m-auto  font-nunito">
      ...
      <div className="flex flex-col gap-y-5 px-10 py-5">
        ...
        <button className='bg-tertiary flex justify-center items-center py-2 rounded-lg border-solid text-bgcolor1 text-xs font-bold uppercase'>Reset Password</button>
